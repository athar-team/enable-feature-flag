...
def load_about():
    about = {}
    with io.open(
        os.path.join(HERE, "tutorenable_feature_flag", "__about__.py"),
        "rt",
        encoding="utf-8",
    ) as f:
...
setup(
    ...
    description="enable-feature-flag plugin for Tutor",
    ...
    entry_points={
        "tutor.plugin.v1": [
            "enable-feature-flag = tutorenable_feature_flag.plugin"
        ]
    },
    classifiers=[
